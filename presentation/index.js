  ...
  render() {
    return (
      ...
      >
        ...
        <Slide bgColor="secondary">
          <svg style={{width: 200, fill: 'white'}} x="0px" y="0px" viewBox="0 0 50 50" enable-background="new 0 0 50 50"><g><g><path d="M50,50H1V1h49V50z M5,46h41V5H5V46z"/><rect x="16" y="17" width="4" height="31"/><rect x="3" y="14" width="45" height="4"/></g><rect x="17" y="30" width="31" height="4"/></g></svg>
          <Heading caps size={1} textColor="tertiary">
            Layout
          </Heading>
